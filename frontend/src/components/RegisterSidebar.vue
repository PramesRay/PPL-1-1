<template>
    <div id="register-bar" class="w-full fixed h-screen z-50 top-0 -left-full backdrop-blur-lg flex duration-300">
        <div id="register-form-bar"
            ...
            <h4 class="text-center font-black text-5xl">REGISTER</h4>
            <div class="w-3/4 flex flex-col justify-between font-semibold gap-10 text-lg">
                <form action="" class="">
                    ...
                    <label for="handphone" class="">No Handphone</label>
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24"
                        class="absolute mt-1.5 ml-2">
                        <path fill="black"
                ...
                <button
                    class="mx-auto bg-accent px-6 py-2 rounded font-bold text-white  hover:scale-95 duration-75">REGISTER</button>
            </div>
        </div>
